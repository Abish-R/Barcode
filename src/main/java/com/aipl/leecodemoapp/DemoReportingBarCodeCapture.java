...
public class DemoReportingBarCodeCapture extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_reporting_bar_code_capture);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.add_new:
                new IntentIntegrator(DemoReportingBarCodeCapture.this).initiateScan();
                break;
            case R.id.submit:
                if(scannedValue.equals(""))
                    ...
                    dbh.addDataToDB_DemoReporting(scannedValue);
                    scannedValue="";

                    Toast.makeText(this, "Data added successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(this,DemoReporting.class));
                    finish();
                }
                break;
            case R.id.fab:
